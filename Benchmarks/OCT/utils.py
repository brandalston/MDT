...
def define_branch_ancestors(leaf_nodes):
    ...
    Only used by OCT and OCT-H (Bertsimas and Dunn).
    
    Returns
    -------
    left_branch_ancestors : dict mapping leaf nodes to list of left-branch ancestors
    right_branch_ancestors : dict mapping leaf nodes to list of right-branch ancestors
    """
